...
func init() {
	...
	proto.RegisterType((*Logs)(nil), "jasper.Logs")
...
type JasperProcessManagerClient interface {
	...
	GetLogs(ctx context.Context, in *JasperProcessID, opts ...grpc.CallOption) (*Logs, error)
...
func (c *jasperProcessManagerClient) GetLogs(ctx context.Context, in *JasperProcessID, opts ...grpc.CallOption) (*Logs, error) {
	out := new(Logs)
...
type JasperProcessManagerServer interface {
	...
	GetLogs(context.Context, *JasperProcessID) (*Logs, error)
...
func _JasperProcessManager_GetLogs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(JasperProcessManagerServer).GetLogs(ctx, req.(*JasperProcessID))
	}
	return interceptor(ctx, in, info, handler)
}
...
var fileDescriptor_d30110796082ce8e = []byte{
	...
	,
}

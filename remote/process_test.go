...
// kim: TODO: make this map[string]jasper.ProcessTestCase
...
func TestProcessImplementations(t *testing.T) {
	...
	testCases := jasper.ProcessTests()
	for testName, testCase := range map[string]jasper.ProcessTestCase{
		"RegisterSignalTriggerFails": func(ctx context.Context, t *testing.T, opts *options.Create, makeProc jasper.ProcessConstructor) {

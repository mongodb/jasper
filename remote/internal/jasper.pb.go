...
type LoggerConfig_Raw struct {
	Raw *RawLoggerConfig `protobuf:"bytes,8,opt,name=raw,proto3,oneof"`
}
...
func (*LoggerConfig) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _LoggerConfig_OneofMarshaler, _LoggerConfig_OneofUnmarshaler, _LoggerConfig_OneofSizer, []interface{}{
...
func _LoggerConfig_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*LoggerConfig)
	// producer
	switch x := m.Producer.(type) {
	case *LoggerConfig_Default:
		b.EncodeVarint(1<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Default); err != nil {
			return err
		}
	case *LoggerConfig_File:
		b.EncodeVarint(2<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.File); err != nil {
			return err
		}
	case *LoggerConfig_Inherited:
		b.EncodeVarint(3<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Inherited); err != nil {
			return err
		}
	case *LoggerConfig_Sumo:
		b.EncodeVarint(4<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Sumo); err != nil {
			return err
		}
	case *LoggerConfig_InMemory:
		b.EncodeVarint(5<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.InMemory); err != nil {
			return err
		}
	case *LoggerConfig_Splunk:
		b.EncodeVarint(6<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Splunk); err != nil {
			return err
		}
	case *LoggerConfig_Buildloggerv2:
		b.EncodeVarint(7<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Buildloggerv2); err != nil {
			return err
		}
	case *LoggerConfig_Raw:
	...
	case nil:
	default:
		return fmt.Errorf("LoggerConfig.Producer has unexpected type %T", x)
	}
	return nil
}

func _LoggerConfig_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*LoggerConfig)
	switch tag {
	case 1: // producer.default
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(DefaultLoggerOptions)
		err := b.DecodeMessage(msg)
		m.Producer = &LoggerConfig_Default{msg}
		return true, err
	case 2: // producer.file
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(FileLoggerOptions)
		err := b.DecodeMessage(msg)
		m.Producer = &LoggerConfig_File{msg}
		return true, err
	case 3: // producer.inherited
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(InheritedLoggerOptions)
		err := b.DecodeMessage(msg)
		m.Producer = &LoggerConfig_Inherited{msg}
		return true, err
	case 4: // producer.sumo
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(SumoLogicLoggerOptions)
		err := b.DecodeMessage(msg)
		m.Producer = &LoggerConfig_Sumo{msg}
		return true, err
	case 5: // producer.in_memory
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(InMemoryLoggerOptions)
		err := b.DecodeMessage(msg)
		m.Producer = &LoggerConfig_InMemory{msg}
		return true, err
	case 6: // producer.splunk
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(SplunkLoggerOptions)
		err := b.DecodeMessage(msg)
		m.Producer = &LoggerConfig_Splunk{msg}
		return true, err
	case 7: // producer.buildloggerv2
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(BuildloggerV2Options)
		err := b.DecodeMessage(msg)
		m.Producer = &LoggerConfig_Buildloggerv2{msg}
		return true, err
	case 8: // producer.raw
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(RawLoggerConfig)
		err := b.DecodeMessage(msg)
		m.Producer = &LoggerConfig_Raw{msg}
		return true, err
	default:
		return false, nil
	}
...
func _LoggerConfig_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*LoggerConfig)
	// producer
	switch x := m.Producer.(type) {
	case *LoggerConfig_Default:
	...
	case *LoggerConfig_Sumo:
		...
		n += s
	case *LoggerConfig_InMemory:
		s := proto.Size(x.InMemory)
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case *LoggerConfig_Splunk:
		s := proto.Size(x.Splunk)
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case *LoggerConfig_Buildloggerv2:
		s := proto.Size(x.Buildloggerv2)
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case *LoggerConfig_Raw:
...
func _LoggingPayloadData_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*LoggingPayloadData)
	// data
	...
	case nil:
	default:
		return fmt.Errorf("LoggingPayloadData.Data has unexpected type %T", x)
	}
	return nil
}

func _LoggingPayloadData_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*LoggingPayloadData)
	switch tag {
	case 1: // data.msg
		if wire != proto.WireBytes {
		...
		m.Data = &LoggingPayloadData_Msg{x}
		return true, err
	case 2: // data.raw
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		...
		m.Data = &LoggingPayloadData_Raw{x}
		return true, err
	default:
		return false, nil
	}
...
func _LoggingPayloadData_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*LoggingPayloadData)
	// data
	switch x := m.Data.(type) {
	case *LoggingPayloadData_Msg:
...
var fileDescriptor_d30110796082ce8e = []byte{
	...
	,
}
